...
if [ "$CC_SRC_LANGUAGE" = "go" -o "$CC_SRC_LANGUAGE" = "golang"  ]; then
	...
	CC_SRC_PATH=github.com/stellar-CC
...
#===================== Chaincode is installed on org1 in mychannel ===================== 
...
#===================== Chaincode is installed on org2 in mychannel ===================== 
...
# ===================== Chaincode is instantiate in mychannel =====================
...
# sleep 10
# docker exec -e "CORE_PEER_LOCALMSPID=Org1MSP" -e "CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp" cli peer chaincode invoke -o orderer.example.com:7050 -C mychannel -n fabcar -c '{"function":"init","Args":["1234567"]}'


cat <<EOF
=========================================
Create network mychannel 2 org success
=========================================
EOF

./home/best/GO-PATH/src/Fabric-stellra/Start\ Fablic/setUpUser.sh
# /home/best/GO-PATH/src/Fabric-stellra/Start\ Fablic/gen.sh

# cat <<EOF
# =========================================
# Genarate user1 for org1 & user2 for org2 success
# Blockchain ready can start API test
# =========================================
# EOF
