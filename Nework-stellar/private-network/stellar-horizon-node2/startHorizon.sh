...
horizon --port 8001 --ingest=true  --db-url="postgresql://stellar:stellar@localhost:5432/horizon2"  --stellar-core-db-url="postgresql://stellar:stellar@localhost:5432/core2"  --stellar-core-url="http://127.0.0.1:11636" --network-passphrase="Private Network ; February 2017"
