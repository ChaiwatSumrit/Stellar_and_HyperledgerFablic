...
class ConfigParser {
    ...
    constructor() {
        ...
        if (!configObject.blockchain.keyValStore) {
            throw ("[Config Parser] Key value store configuraton is missing. Please provide value for 'keyValStore' attribute: 'keyValStore':{'fileSystem'|'cloudant':'fileSystemPath'|'cloudantDbName'}")
        }
    ...
    //TODO: Complete properties validation.
    getUserApiDbName() {
        if (!this.cloudantUserApiDbName) {
            logger.error("[Config Parser] Cloudant database name is not specified. It should be a value of 'cloudant_restapi_user' property of 'blockchain' config object. Please specify something like 'cloudant':'myDatabaseName'.");
            return null
        };
        return this.cloudantUserApiDbName;
    }

    // getKVSCosInfra() {
    //     if (!this.cosEndpoint) {
    //         logger.error("[Config Parser] COS endpoint is not specified. It should be a value of 'cosInfra' property of 'blockchain' config object.");
    //         return null
    //     }
    //     if (!this.cosRegion) {
    //         logger.error("[Config Parser] COS region is not specified. It should be a value of 'cosInfra' property of 'blockchain' config object.");
    //         return null
    //     }
    //     return {
    //         accessKeyId: this.cosAccessKeyInfra,
    //         secretAccessKey: this.secretAccessKeyInfra,
    //         endpoint: this.cosEndpointInfra,
    //         region: this.cosRegionInfra
    //     }
    // }
    ...
    // //TODO: Complete properties validation.
    // getBlockchainChaincode2() {
    //     if (!this.blockchainChaincode2) {
    //         logger.error("[Config Parser] Chaincode ID is not specified. It should be a value of 'chaincodeId' propery of 'blockchain' config object. Please specify something like 'chaincodeId':'mychaincode'.");
    //         return null
    //     };
    //     return this.blockchainChaincode2;
    // }
    //TODO: Complete properties validation.
    getBlockchainMSPId() {
